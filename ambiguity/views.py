...
def vars_for_all_templates(self):
    phase_no = self.session.config['app_sequence'].index('ambiguity')
...
class Choice(Page):
    ...
    def vars_for_template(self):
        self.player.risk  = self.session.vars['ambiguity_risks'][self.round_number-1][self.player.id_in_group - 1]
        #return {'msg_risk' : '{}%'.format(self.player.risk)}
